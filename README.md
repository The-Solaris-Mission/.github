...
### 🔭 Current Projects
- **Ion Propulsion Simulation**: Developing and refining simulations for ion propulsion systems.
- **Astrobiology Database**: Creating a database to store and analyze data on biosignatures from potential habitable planets.
- **Virtual Space Settlements**: Building 3D models and simulations of space habitats.
